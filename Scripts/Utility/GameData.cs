...
namespace Slay_The_Basilisk_MonoGame
{
    ...
    public static class GameData
    {
        ...
        public static CharacterElementStats RookStats = new CharacterElementStats { Damage = 0, MaxHealth = 50, AttackCooldown = 1.2d, MoveCooldown = 1.2d };
        public static CharacterElementStats BishopStats = new CharacterElementStats { Damage = 0, MaxHealth = 30, AttackCooldown = 1.5d, MoveCooldown = 0.75d };
        public static CharacterElementStats QueenStats = new CharacterElementStats { Damage = 0, MaxHealth = 30, AttackCooldown = 1.5d, MoveCooldown = 0.75d };
